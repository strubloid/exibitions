...
// Mobile: cards animate in rows of 3 — one scroll step reveals a whole row
...
function calculateCardScrollPositions(cardCount: number, viewportHeight: number) {
  ...
  if (mobile) {
    // Group cards into rows of 3 — each row shares the same scroll timing
  ...
  // Desktop: one card per scroll step
